...
# 			signal.alarm(time_limit)
		...
		if winning_color == 1 and play_counter != 1:
			print("b",first_move)
		elif winning_color == 1 and play_counter ==1:
			print("w",first_move)
		elif winning_color == 2 and play_counter != 1:
			print("w",first_move)
		elif winning_color == 2 and play_counter == 1:
			print("b",first_move)
